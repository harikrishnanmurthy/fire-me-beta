...
<body>
							...
							<table class="table table-striped table-condensed"
								...
								<thead>
									<tr>
										...
										<th width="7%">Tax Rate</th>
										<th width="7%">Tax Invoice Flag</th>
										<th width="7%">Tax Code Desc</th>
				...
				<div class="modal hide" id="changePassword" tabindex="-1">
					...
					<div class="modal-body" style="height: 220px;">
						...
						<form id="changePasswordForm" name="changePasswordForm"
							method="get" class="well form-horizontal" action="http://10.3.9.245:9997/taxcode/create/49">
							...
							<div class="control-group" id="changePasswordFormPasswordGroup">
								<label class="control-label" for="inputPassword">Tax Rate</label>
								<div class="controls">
									<input type="text" id="changetaxrate" name="taxrt"
										class="noEnterSubmit" />
								</div>
							</div>
							<div class="control-group" id="changePasswordFormPasswordGroup">
								<label class="control-label" for="inputPassword">Tax Invoice Flag</label>
								<div class="controls">
									<input type="text" id="changetaxinvoiceflag" name="taxinvflag"
										class="noEnterSubmit" />
								</div>
							</div>
							<div class="control-group"
								id="changePasswordFormonfirmPasswordGroup">
								<label class="control-label" for="inputonfirmPassword">Tax Code Desc</label>
								<div class="controls">
									<input type="text" id="changetaxcodedesc" name="tax_cd_desc"
										class="noEnterSubmit" />
								</div>
							</div>
							<div class="control-group"
	...
	<script type="text/javascript" src="js/listTaxCodehome.js"></script>
