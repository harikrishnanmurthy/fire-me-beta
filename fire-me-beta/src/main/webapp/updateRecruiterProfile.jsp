...
<div class="modal fade" id="jobSeekerProfileConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			You have successfully updated your profile. What's next???
      </div>
...
<script>
$(function(){
	$("#jobSeekerProfileConfirm").modal("show");
